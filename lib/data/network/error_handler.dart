...
class ErrorHandler implements Exception {
  ...
  Failure _getResponseError(DioException error) {
...
extension DataSourceExtension on DataSource {
  getFailure() {
    switch (this) {
      ...
      case DataSource.WRONG_OTP_CODE:
        Failure(ResponseCode.DEFAULT, ResponseMessage.WRONG_OTP_CODE);
      default:
...
class ResponseMessage {
  ...
  static String CANCEL = AppStrings.unknownError.tr();
  ...
  static String WRONG_OTP_CODE = AppStrings.wrongCode.tr();
}
